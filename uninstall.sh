#! /bin/bash
#
# Subnodes file-share uninstall script. Removes samba.
# Sarah Grant
# Updated 22 May 2015
#
#
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# Uninstall Subnodes Fileshare
#
read -p "Do you wish to uninstall subnodes file sharing from your Raspberry Pi? [N] " yn
case $yn in
	[Yy]* )
		clear
